...
export declare const MarkToolbarButton: React.ForwardRefExoticComponent<Omit<{
    ...
    size?: "default" | "sm" | "lg" | null | undefined;
    variant?: "default" | "outline" | null | undefined;
} & import("class-variance-authority/types").ClassProp) | undefined) => string> & React.RefAttributes<HTMLButtonElement>, "ref"> & Omit<import("@radix-ui/react-tooltip").TooltipProviderProps, "children"> & React.RefAttributes<HTMLButtonElement>, "ref"> & {
    nodeType: string;
    clear?: string[] | string;
