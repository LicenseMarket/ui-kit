...
export function EmojiPickerSearchAndClear({
  ...
  return (
    <div className="text-foreground flex items-center">
      <div
        className={cn(
          `text-foreground absolute left-2.5 top-1/2 z-10 flex size-5 -translate-y-1/2
      ...
      {searchValue && (
        <Button
          ...
          variant="ghost"
          className={cn(
            `text-popover-foreground absolute right-0.5 top-1/2 flex size-8 -translate-y-1/2
