...
import SheetHeaderComponent, { SheetHeaderProps } from "../global/SheetHeader";
    ...
    return (
      <SheetPortal>
        ...
        <SheetPrimitive.Content
          ref={ref}
          className={`bg-background ${nestedOpen ? nestedClass : ""} ${cn(sheetVariants({ side }),
            className)}`}
          {...props}
        >
